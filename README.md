...
本アプリ([TLFormatter](https://tl-formatter.vercel.app/))はプリコネアプリから出力した TL を整形するためのアプリです。整形のフォーマットはカスタマイズが可能です。カスタマイズしたフォーマットは Share ボタンにより出力された URL で共有することが可能です。
